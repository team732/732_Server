...
import { dbConnect, query, resultArray, randomString, SUCCESS, INVALID_REQUEST, SERVER_ERROR, EMAIL_REGEXP, LOGIN_ID_REGEXP, LOGIN_EXPIRY_TIME } from '../../utils';
    ...
    dbConnect(res).then((connection) => {
        try{
            ...
            .then((insertResult) => {
                ...
                let payLoad = { userId : decoded.userId };
